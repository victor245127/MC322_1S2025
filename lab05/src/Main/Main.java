            ...
            switch (opcao) {
                case 1:
                    ...
                    for (Entidade obs : ambiente.getObstaculos()) {
                        Obstaculos o = (Obstaculos) obs;
                        System.out.printf("Tipo: %s\n", o.getTipoObstaculo());
                        System.out.printf("Posicao: (%d,%d,%d) ate (%d,%d,%d)\n", o.getX()[0], o.getY()[0], 0, o.getX()[1], o.getY()[1], o.getTipoObstaculo().getAltura());
                ...
                case 3:
                    try {
                        ...
                        if (esc < 1 || esc > ambiente.getRobos().size()) throw new EscolhaInvalidaException();
                        Robo r = (Robo) ambiente.getRobos().get(esc - 1);
                        if (r.getEstado() == EstadoRobo.desligado) r.ligar();
                        else r.desligar();
                ...
                case 4:
                    try {
                        ...
                        for (int a = 0; a < ambiente.getEntidades().size(); a++) {
                            ...
                            if (e.getTipo() == TipoEntidade.ROBO) System.out.printf("%d. %s\n", (a + 1), ((Robo) e).getId());
                            else System.out.printf("%d. %c\n", (a + 1), e.getTipo().getRepresentacao(e.getTipo()));
                        }
                        int escolha = scanner.nextInt();
                        scanner.nextLine();
                        if (escolha < 1 || escolha > ambiente.getEntidades().size()) throw new EscolhaInvalidaException();
                ...
                case 7:
                    try {
                        ...
                        scanner.nextLine();
                        if (e < 1 || e > ambiente.getRobos().size()) throw new EscolhaInvalidaException();
                        e -= 1;
                        if (ambiente.getRobos().get(e) instanceof RoboAereoFalcao) ((RoboAereoFalcao) ambiente.getRobos().get(e)).executarTarefa(ambiente);
                        else if (ambiente.getRobos().get(e) instanceof RoboAereoObservador) ((Autonomo) ambiente.getRobos().get(e)).Autonomia(ambiente);
                        else if (ambiente.getRobos().get(e) instanceof RoboTerrestreDestruidor) ((RoboTerrestreDestruidor) ambiente.getRobos().get(e)).executarTarefa(ambiente);
                        else if (ambiente.getRobos().get(e) instanceof RoboTerrestreExplorador) ((RoboTerrestreExplorador) ambiente.getRobos().get(e)).executarTarefa(ambiente);
                    } catch (EscolhaInvalidaException ei) {
                        System.out.println("ERRO: " + ei.getMessage());
                    }
                    break;
                ...
                case 9:
                    try {
                        ...
                        if (r1 == r2) throw new ErroDestinatarioException();
                        if (r1 < 1 || r2 < 1 || r1 > ambiente.getRobos().size() || r2 > ambiente.getRobos().size()) throw new EscolhaInvalidaException();
                        ...
                        } else throw new ErroComunicacaoException();
                    } catch (ErroComunicacaoException | ErroDestinatarioException | EscolhaInvalidaException ex) {
